...
export default function AboutUs() {
  ...
  const values = [
    {
      title: "Transparency",
      description: "Complete honesty in every interaction and process."
    },
    {
      title: "Excellence",
    ...
    {
      title: "Innovation",
      description: "Embracing new technologies to enhance learning."
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>About EduOrbix | Study Abroad & Education Consultants</title>

        <meta
          name="description"
          content="Learn about EduOrbix, a trusted education consultancy helping students with study abroad, study in India, university admissions, scholarships, and career guidance."
        />

        <meta
          name="keywords"
          content="About EduOrbix, education consultant, study abroad consultant, university admission guidance, scholarship assistance, student counselling, overseas education"
        />

        <meta name="author" content="EduOrbix" />
        <meta name="robots" content="index, follow" />

        <link rel="canonical" href="https://eduorbix.com/about-us" />

        <meta
          property="og:title"
          content="About EduOrbix | Study Abroad & Education Consultants"
        />

        <meta
          property="og:description"
          content="EduOrbix helps students secure admissions in reputed colleges and universities across India and globally."
        />

        <meta property="og:url" content="https://eduorbix.com/about-us" />
        ...
        <meta
          name="twitter:title"
          content="About EduOrbix | Education Consultants"
        />

        <meta
          name="twitter:description"
          content="Trusted education consultancy for study abroad, admissions, scholarships, and student guidance."
        />
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="relative bg-gradient-to-r from-[#0A1F44] via-[#143472] to-[#1F3A6E] overflow-hidden">
            ...
            <div className="text-center">
              <div className="space-y-4">
                ...
                <p className="text-sm text-white/80 max-w-xl mx-auto">
                  Eduorbix is a professional education consultancy platform
                  dedicated to helping students secure admission in reputed
                  colleges and universities across India and globally.
                </p>
          ...
          <div className="absolute bottom-0 left-0 right-0 z-30">
            ...
            >
              <path
                d="M0 32L60 42.7C120 53 240 75 360 74.7C480 75 600 53 720 48C840 43 960 53 1080 58.7C1200 64 1320 64 1380 64L1440 64V120H1380C1320 120 1200 120 1080 120C960 120 840 120 720 120C600 120 480 120 360 120C240 120 120 120 60 120H0V32Z"
                fill="#F9FAFB"
              />
            </svg>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-20">
            <div className="group bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                To become a globally trusted education advisory platform that
                bridges the gap between aspiring students and their dream
            ...
            <div className="group bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                To empower students with the right information, personalized
                guidance, and structured support systems that enable academic
          ...
          <div className="bg-gray-50 rounded-2xl md:rounded-3xl p-5 sm:p-6 md:p-10 mb-14 md:mb-20">
            ...
            <div className="bg-gradient-to-r from-[#0A1F44] to-[#1F3A6E] rounded-lg md:rounded-xl p-4 sm:p-5 md:p-6 text-center">
              <p className="text-white text-sm sm:text-base leading-relaxed">
                ...
                Global partner network across 15+ countries with 100+
          ...
          <div className="relative bg-gradient-to-r from-[#0A1F44] to-[#1F3A6E] rounded-3xl overflow-hidden">
            ...
            <div className="relative p-10 md:p-12 text-center">
              ...
              <p className="text-white/80 mb-8 max-w-2xl mx-auto">
                Join thousands of successful students who trusted Eduorbix for
