      ...
      <div className="max-w-5xl mx-auto bg-white rounded-3xl p-8 shadow border">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="Case Study Title"
            className="w-full border rounded-xl px-4 py-2 focus:ring-2 focus:ring-purple-400"
            required
          />
          ...
          {selectedImage && (
            <div className="border-2 border-purple-200 rounded-xl p-4 bg-purple-50">
              ...
              <p className="text-xs text-purple-600 mt-2">
                💡 Drag green handles to resize manually. Hold Shift for aspect ratio.
              </p>
            </div>
          )}
          ...
          <div
            ref={editorRef}
            contentEditable
            className="min-h-[400px] border rounded-xl p-4 focus:outline-none focus:ring-2 focus:ring-purple-400 prose max-w-none"
            suppressContentEditableWarning
          />
